...
*/
    ...
    constexpr auto static initLayoutCentering_() {
        ...
        const std::array<QtyCentering, NBR_COMPO> Mxx = {{data.primal, data.primal, data.primal}};
        const std::array<QtyCentering, NBR_COMPO> Mxy = {{data.primal, data.primal, data.primal}};
        const std::array<QtyCentering, NBR_COMPO> Mxz = {{data.primal, data.primal, data.primal}};
        const std::array<QtyCentering, NBR_COMPO> Myy = {{data.primal, data.primal, data.primal}};
        const std::array<QtyCentering, NBR_COMPO> Myz = {{data.primal, data.primal, data.primal}};
        const std::array<QtyCentering, NBR_COMPO> Mzz = {{data.primal, data.primal, data.primal}};
   ...
   public:
    NO_DISCARD constexpr static std::array<QtyCentering, dim> centering(
        HybridQuantity::Scalar _Quantity) {
        ...
        if constexpr (dim == 1) {
            switch (_Quantity) {
                ...
                default:
                    throw std::runtime_error("Wrong _Quantity");
            }
        }
    ...
    NO_DISCARD constexpr static std::array<std::array<QtyCentering, dim>, 3> centering(
        HybridQuantity::Vector _Quantity) {
        switch (_Quantity) {
    ...
    NO_DISCARD auto static constexpr ByToEx() {  // By is dual primal dual
        // Ex is dual primal primal
