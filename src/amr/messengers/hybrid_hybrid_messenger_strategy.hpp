...
namespace amr
{
    ...
    private:
        ...
        SynchronizerPool<rm_t, dimension> densitySynchronizers_;
        SynchronizerPool<rm_t, dimension> ionBulkVelSynchronizers_;
        SynchronizerPool<rm_t, dimension> electroSynchronizers_;
        SynchronizerPool<rm_t, dimension> magnetoSynchronizers_;
