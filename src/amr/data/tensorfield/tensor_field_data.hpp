...
class TensorFieldData : public SAMRAI::hier::PatchData
{
    ...
    auto constexpr static N = core::detail::tensor_field_dim_from_rank<rank>();
...
private:
    ...
    TensorFieldDataInternals<GridLayoutT, dimension, Grid_t, PhysicalQuantity> internals_;
}; // namespace PHARE
...
class TensorFieldDataInternals<GridLayoutT, 1, Grid_t, PhysicalQuantity>
{
public:
                  ...
                  SAMRAI::hier::Box const& localDestinationBox, Grid_t& destination) const
    {
        ...
        std::uint32_t xDestinationStart = static_cast<std::uint32_t>(localDestinationBox.lower(0));

        std::uint32_t xSourceEnd      = static_cast<std::uint32_t>(localSourceBox.upper(0));
        std::uint32_t xDestinationEnd = static_cast<std::uint32_t>(localDestinationBox.upper(0));
...
template<typename GridLayoutT, typename Grid_t, typename PhysicalQuantity>
class TensorFieldDataInternals<GridLayoutT, 2, Grid_t, PhysicalQuantity>
{
public:
    void copyImpl(SAMRAI::hier::Box const& localSourceBox, Grid_t const& source,
                  SAMRAI::hier::Box const& localDestinationBox, Grid_t& destination) const
    {
        ...
        std::uint32_t yDestinationStart = static_cast<std::uint32_t>(localDestinationBox.lower(1));

        std::uint32_t ySourceEnd      = static_cast<std::uint32_t>(localSourceBox.upper(1));
        std::uint32_t yDestinationEnd = static_cast<std::uint32_t>(localDestinationBox.upper(1));
...
template<typename GridLayoutT, typename Grid_t, typename PhysicalQuantity>
class TensorFieldDataInternals<GridLayoutT, 3, Grid_t, PhysicalQuantity>
{
public:
    void copyImpl(SAMRAI::hier::Box const& localSourceBox, Grid_t const& source,
                  SAMRAI::hier::Box const& localDestinationBox, Grid_t& destination) const
    {
        ...
        std::uint32_t zDestinationStart = static_cast<std::uint32_t>(localDestinationBox.lower(2));

        std::uint32_t zSourceEnd      = static_cast<std::uint32_t>(localSourceBox.upper(2));
        std::uint32_t zDestinationEnd = static_cast<std::uint32_t>(localDestinationBox.upper(2));
